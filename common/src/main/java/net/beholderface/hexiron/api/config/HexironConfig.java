package net.beholderface.hexiron.api.config;
...
public class HexironConfig {
    ...
    public static void setCommon(CommonConfigAccess common) {
        if (HexironConfig.common != dummyCommon) {
            Hexiron.LOGGER.warn("CommonConfigAccess was replaced! Old {} New {}", HexironConfig.common.getClass().getName(), common.getClass().getName());
        }
        HexironConfig.common = common;
    }
    ...
    public static void setClient(ClientConfigAccess client) {
        if (HexironConfig.client != dummyClient) {
            Hexiron.LOGGER.warn("ClientConfigAccess was replaced! Old {} New {}", HexironConfig.client.getClass().getName(), client.getClass().getName());
        }
        HexironConfig.client = client;
    }
    ...
    public static void setServer(ServerConfigAccess server) {
        ...
        if (HexironConfig.server != dummyServer) {
            Hexiron.LOGGER.warn("ServerConfigAccess was replaced! Old {} New {}", HexironConfig.server.getClass().getName(), server.getClass().getName());
        }
        HexironConfig.server = server;
    }
